...
public class Message_6_25 implements IMessage {

	private static int MAIN = 6;
	private static int SUB = 25;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(6, 25);
	...
	public static Message_6_25 create() {
		return new Message_6_25();
	}
