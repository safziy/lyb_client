...
public class Message_1009_18 implements IMessage {

	private static int MAIN = 1009;
	private static int SUB = 18;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1009, 18);
	...
	public static Message_1009_18 create() {
		return new Message_1009_18();
	}
