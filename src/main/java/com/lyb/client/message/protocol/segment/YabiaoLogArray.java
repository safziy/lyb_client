...
public class YabiaoLogArray implements IMessageEncoder {
	private List<YabiaoLogArrayItem> list = new LinkedList<YabiaoLogArrayItem>();

	public List<YabiaoLogArrayItem> list(){
		return list;
	}
	...
	public void encode(Data data) {
		...
		for (YabiaoLogArrayItem item : list) {
	...
	public void decode(Data data) {
		...
		for (int i = 0; i < size; i++) {
			YabiaoLogArrayItem item = YabiaoLogArrayItem.create();
	...
	public static YabiaoLogArray create() {
		YabiaoLogArray array = new YabiaoLogArray();
		return array;
	}

	public static YabiaoLogArrayItem createItem() {
		YabiaoLogArrayItem item = new YabiaoLogArrayItem();
		return item;
	}

	public YabiaoLogArrayItem addData(long iD, String paramStr1, String paramStr2, String paramStr3, int time) {
		YabiaoLogArrayItem item = new YabiaoLogArrayItem();
		item.setID(iD);
	...
	public void addItem(YabiaoLogArrayItem item) {
		list.add(item);
	}
	...
	public static class YabiaoLogArrayItem implements IMessageEncoder {
		private long iD;
		...
		public static YabiaoLogArrayItem create() {
			YabiaoLogArrayItem item = new YabiaoLogArrayItem();
			return item;
		}
