...
public class Message_6_26 implements IMessage {

	private static int MAIN = 6;
	private static int SUB = 26;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(6, 26);
	...
	public static Message_6_26 create() {
		return new Message_6_26();
	}
