...
public class Message_1021_12 implements IMessage {

	private static int MAIN = 1021;
	private static int SUB = 12;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1021, 12);

	private IDArray iDArray;


	public static Message_1021_12 create() {
		return new Message_1021_12();
	}
